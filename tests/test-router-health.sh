...
assert_contains "$MARKDOWN_OUT" "Mobile/QR connections:"
assert_contains "$MARKDOWN_OUT" "Mobile/QR byte total:"
assert_contains "$MARKDOWN_OUT" "Mobile/QR via Reality:"
assert_contains "$MARKDOWN_OUT" "Mobile/QR direct-out:"
