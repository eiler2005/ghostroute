...
assert_contains "modules/routing-core/bin/managed-egress-mode" 'ABC_MODES="primary_vps backup_reality hermes_vps"'
assert_contains "modules/routing-core/bin/managed-egress-mode" 'Channel A/B/C'
assert_contains "modules/routing-core/bin/managed-egress-mode" 'Channel M is not switched'
