...
assert_not_contains_fixed "$DNSMASQ_CATALOG" "ipset=/smtp.gmail.com/STEALTH_DOMAINS"
assert_not_contains_fixed "$DNSMASQ_CATALOG" "ipset=/imap.gmail.com/STEALTH_DOMAINS"
assert_contains_fixed "$DNSMASQ_CATALOG" "ipset=/discord.com/STEALTH_DOMAINS"
assert_contains_fixed "$DNSMASQ_CATALOG" "ipset=/konami.com/STEALTH_DOMAINS"
assert_contains_fixed "$DNSMASQ_CATALOG" "ipset=/konami.net/STEALTH_DOMAINS"
assert_contains_fixed "$DNSMASQ_CATALOG" "ipset=/my.konami.net.edgekey.net/STEALTH_DOMAINS"
assert_contains_fixed "$DNSMASQ_CATALOG" "ipset=/pes22-prd-lb-1361062069.us-west-2.elb.amazonaws.com/STEALTH_DOMAINS"
assert_contains_fixed "$DNSMASQ_CATALOG" "ipset=/efootball-prod-frontdoor-endpoint-user-api-eseddha0a8esekda.z01.azurefd.net/STEALTH_DOMAINS"
assert_contains_fixed "$DNSMASQ_CATALOG" "ipset=/eu-irl-00001.s3.dualstack.eu-west-1.amazonaws.com/STEALTH_DOMAINS"
