...
assert_contains "$VERIFY" 'Channel M reverse services-start boot recovery is installed when enabled'
...
assert_contains "ansible/playbooks/23-channel-m-reverse.yml" 'sleep 45'
assert_contains "ansible/playbooks/23-channel-m-reverse.yml" 'services-start'
assert_contains "ansible/playbooks/23-channel-m-reverse.yml" 'SingBoxWatchdog'
assert_contains "modules/routing-core/router/services-start" 'SingBoxWatchdog'
