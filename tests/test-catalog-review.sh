...
CATALOG_REVIEW_DNSMASQ_FILE="${PROJECT_ROOT}/tests/fixtures/catalog-review/dnsmasq-sample.conf.add" \
CATALOG_REVIEW_STATIC_FILE="${PROJECT_ROOT}/tests/fixtures/catalog-review/static-networks-sample.txt" \
CATALOG_REVIEW_STATE_FILE="${PROJECT_ROOT}/tests/fixtures/catalog-review/state-sample.env" \
