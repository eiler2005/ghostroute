...
assert_contains "ansible/roles/caddy_l4/templates/channel-c-squid.conf.j2" 'happy_eyeballs_connect_timeout 10'
...
assert_contains "modules/client-profile-factory/docs/client-profiles.md" 'Channel B XHTTP Future Manual Profiles'
