...
assert_contains "ansible/playbooks/22-channel-c-router.yml" 'C1-Shadowrocket compatibility listener is running when enabled'
...
assert_contains "ansible/roles/singbox_client/templates/config.json.j2" '"type": "http"'
assert_contains "ansible/roles/singbox_client/templates/config.json.j2" '"tag": "channel-c-shadowrocket-http-in"'
assert_contains "ansible/roles/singbox_client/templates/config.json.j2" '"inbound": "channel-c-shadowrocket-http-in", "action": "sniff"'
assert_contains "ansible/roles/singbox_client/templates/config.json.j2" 'channel-a-selected-lan-full-vps-in.*\"action\": \"sniff\"'
assert_contains "ansible/roles/singbox_client/templates/config.json.j2" 'control_plane_direct_domain_suffixes'
assert_contains "ansible/roles/singbox_client/templates/config.json.j2" 'control_plane_direct_ports'
...
assert_contains "ansible/roles/singbox_client/tasks/main.yml" 'Validate Channel C1 Shadowrocket compatibility settings'
...
assert_contains "ansible/group_vars/routers.yml" 'channel_c_sfi_native_profiles_enabled'
assert_contains "ansible/group_vars/routers.yml" 'channel_c_shadowrocket_enabled'
assert_contains "ansible/group_vars/routers.yml" 'channel_c_shadowrocket_public_port'
assert_contains "ansible/group_vars/routers.yml" 'router_control_plane_direct_domain_suffixes'
assert_contains "ansible/group_vars/routers.yml" 'sslip.io'
assert_contains "ansible/group_vars/routers.yml" 'router_control_plane_direct_ports'
...
assert_contains "ansible/roles/stealth_routing/templates/stealth-route-init.sh.j2" 'CHANNEL_C_SHADOWROCKET_PUBLIC_PORT'
assert_contains "ansible/roles/stealth_routing/templates/stealth-route-init.sh.j2" 'mobile-shadowrocket-channel-c-ingress'
assert_contains "ansible/roles/stealth_routing/templates/ghostroute-runtime.env.j2" 'GHOSTROUTE_CHANNEL_C_HOME_PORT'
assert_contains "ansible/roles/stealth_routing/templates/ghostroute-runtime.env.j2" 'GHOSTROUTE_CHANNEL_C_SHADOWROCKET_PORT'
...
assert_contains "ansible/playbooks/30-generate-client-profiles.yml" 'Render C1-Shadowrocket HTTPS CONNECT URL'
...
assert_contains "ansible/playbooks/30-generate-client-profiles.yml" 'channel_c_sfi_native_profiles_enabled'
...
assert_not_contains "ansible/playbooks/30-generate-client-profiles.yml" 'naive-uri|https-probe|sfi-sing-box.png|SFI QR'
