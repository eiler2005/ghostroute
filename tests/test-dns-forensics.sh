...
DOMAIN_AUTO_ADD_LOG_FILE="${PROJECT_ROOT}/tests/fixtures/dns-forensics/dnsmasq-sample.log" \
DOMAIN_AUTO_ADD_LEASES_FILE="${PROJECT_ROOT}/tests/fixtures/dns-forensics/dnsmasq-leases-sample.txt" \
...
DNS_FORENSICS_SOURCE_DIR="${PROJECT_ROOT}/tests/fixtures/dns-forensics" \
DNS_FORENSICS_DEVICE_METADATA_FILE="${PROJECT_ROOT}/tests/fixtures/dns-forensics/device-metadata-sample.tsv" \
