...
assert_contains "$DNSCRYPT_TASKS" "echo 1 > /proc/sys/vm/overcommit_memory"
assert_contains "ansible/roles/dnscrypt_proxy/templates/S09dnscrypt-proxy2.j2" "ensure_go_runtime_overcommit"
assert_contains "ansible/roles/dnscrypt_proxy/templates/S09dnscrypt-proxy2.j2" "overcommit_memory"
...
assert_contains "$VERIFY" "dnscrypt-proxy Go runtime overcommit guard is enabled"
assert_contains "modules/recovery-verification/bin/verify.sh" "dnscrypt-proxy Go runtime may fail before config parsing"
...
assert_contains "modules/shared/lib/router-health-common.sh" "DNSCRYPT_GO_OVERCOMMIT"
...
assert_contains "modules/ghostroute-health-monitor/bin/router-health-report" "dnscrypt_go_overcommit"
assert_contains "README.md" "/jffs/scripts/dnscrypt-watchdog.sh"
assert_contains "README.md" "vm.overcommit_memory=1"
assert_contains "README-ru.md" "/jffs/scripts/dnscrypt-watchdog.sh"
assert_contains "README-ru.md" "vm.overcommit_memory=1"
assert_contains "docs/architecture.md" "dnscrypt-watchdog.sh"
assert_contains "docs/architecture.md" "strict overcommit"
assert_contains "docs/dns-policy.md" "dnscrypt-watchdog.sh"
assert_contains "docs/dns-policy.md" "strict overcommit"
assert_contains "docs/troubleshooting.md" "DnscryptWatchdog"
assert_contains "docs/troubleshooting.md" "overcommit_memory"
