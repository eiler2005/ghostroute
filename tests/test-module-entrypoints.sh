...
assert_executable "modules/traffic-observatory/bin/traffic-evidence"
assert_executable "modules/traffic-observatory/bin/live-check"
assert_executable "modules/traffic-observatory/bin/traffic-daily-report"
assert_executable "modules/traffic-observatory/bin/traffic-summary"
...
assert_executable "modules/ghostroute-health-monitor/bin/egress-backend-health"
assert_executable "modules/ghostroute-health-monitor/bin/egress-dpi-probe"
...
assert_executable "modules/routing-core/bin/build-channel-d-caddy"
