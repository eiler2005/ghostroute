...
| Endpoint blocking | Medium | VPS IP заблокирован на upstream/path стороне | curl ifconfig.me с iPhone (через VPN), сравнить с прямым | Есть emergency direct-VPS profile (отдельный от home QR) | — |
