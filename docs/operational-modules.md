...
| GhostRoute Console | Tailnet-only read-only web console over factual JSON snapshots from the operational modules. | `modules/ghostroute-console` | `./modules/ghostroute-console/bin/ghostroute-console` | local/VPS container data at `ghostroute-console/data` or `/opt/ghostroute-console/data` | `modules/ghostroute-console/README.md` | `./modules/ghostroute-console/tests/test-json-contracts.sh`, app `npm test` | Read-only observability; no routing/catalog mutations |
