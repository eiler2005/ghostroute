...
| Traffic Observatory | WAN/LAN/Wi-Fi/Home Reality usage, lightweight Dashboard counter summaries, QR-client activity, destination popularity, route evidence and log-tail live events. | `modules/traffic-observatory` | `./modules/traffic-observatory/bin/traffic-summary`, `./modules/traffic-observatory/bin/traffic-report`, `./modules/traffic-observatory/bin/traffic-daily-report`, `./modules/traffic-observatory/bin/live-events-report` | router traffic counters and read-only router log tails, local report output | `modules/traffic-observatory/docs/traffic-observability.md`, `modules/traffic-observatory/docs/llm-traffic-runbook.md`, `docs/ghostroute-console-architecture.md` | traffic/console JSON contract fixtures via `tests/run-all.sh` | Read-only diagnostics |
