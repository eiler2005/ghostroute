...
Remote QR mobile clients -> home IP :443 -> sing-box home Reality inbound -> Reality outbound -> VPS
...
| mobile QR | generated VLESS/Reality profile | n/a | home ASUS `:443` -> sing-box -> VPS |
...
mobile QR    -> home IP :443 -> sing-box Reality inbound -> VPS Reality outbound
```
...
- `0.0.0.0:443` is owned by `sing-box` for the home Reality mobile ingress.
