...
[ "$(router_kv_get "$STATE_FILE" MANAGED_VPS_DNS_INCLUDE)" = "1" ] || add_critical "managed DNS include is missing"
...
printf "%-34s %s\n" "managed DNS include" "$( [ "$(router_kv_get "$STATE_FILE" MANAGED_VPS_DNS_INCLUDE)" = "1" ] && echo OK || echo MISSING )"
