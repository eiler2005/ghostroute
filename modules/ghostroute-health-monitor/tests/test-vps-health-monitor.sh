...
cp "$PROJECT_ROOT/modules/ghostroute-health-monitor/vps/lib.sh" "$STAGE/lib.sh"
cp "$PROJECT_ROOT/modules/ghostroute-health-monitor/vps/run-probes" "$STAGE/run-probes"
cp "$PROJECT_ROOT/modules/ghostroute-health-monitor/router/aggregate" "$STAGE/aggregate"
cp "$PROJECT_ROOT/modules/ghostroute-health-monitor/router/daily-digest" "$STAGE/daily-digest"
cp "$PROJECT_ROOT/modules/ghostroute-health-monitor/router/run-once" "$STAGE/run-once"
chmod 0755 "$STAGE"/*
