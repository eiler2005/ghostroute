...
Полная схема алгоритма: [modules/dns-catalog-intelligence/docs/domain-management.md](domain-management.md#алгоритм----как-домен-попадает-в-vpn).
...
- [architecture.md](../../../docs/architecture.md) — как устроена маршрутизация и где место auto-discovery
- [modules/dns-catalog-intelligence/docs/domain-management.md](domain-management.md) — как добавлять домены вручную и работать с авто-добавленными
- [modules/routing-core/docs/current-routing-explained.md](../../routing-core/docs/current-routing-explained.md) — полный список роутимых доменов
- [remote-access-overlay-migration.md](../../../docs/remote-access-overlay-migration.md) — planning-only future direction по замене публичного `wgs1` на overlay / zero-trust remote access слой
