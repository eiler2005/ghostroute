...
| `icloud.com`, `icloud.apple.com`, `icloud-content.com`, `apple-cloudkit.com`, `apple-livephotoskit.com`, `iwork.apple.com`, `gc.apple.com` | Apple sync may be latency-sensitive and often direct-capable; some Apple domains are also Reality cover/fallback adjacent. | `needs-live-evidence`; do not remove blindly |
