...
MIN_COUNT=1
MODE="${1:-run}"
CANDIDATE_EVENTS_STATE="${CANDIDATE_EVENTS_STATE:-/opt/tmp/domain-auto-add-candidate-events.tsv}"
PROBE_HISTORY_STATE="${PROBE_HISTORY_STATE:-/opt/tmp/domain-auto-add-probe-history.tsv}"
